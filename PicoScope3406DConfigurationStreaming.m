function varargout = PicoScope3406DConfigurationStreaming(varargin)
% GUI for P2Scan Scope Configuration
%
% Derek Liu
% 11/10/14

% Last Modified by GUIDE v2.5 14-Apr-2017 15:25:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @PicoScope3406DConfigurationStreaming_OpeningFcn, ...
    'gui_OutputFcn',  @PicoScope3406DConfigurationStreaming_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function PicoScope3406DConfigurationStreaming_OpeningFcn(hObject, eventdata, handles, varargin)
S1 = getappdata(0,'S1');
...
function varargout = PicoScope3406DConfigurationStreaming_OutputFcn(hObject, eventdata, handles)
...
%VerticalRangeDefaults = [0.02 0.05 0.1 0.2 0.5 1.0 2.0 5.0 10.0 20.0];
