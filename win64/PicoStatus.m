%PICOSTATUS Defines constant values to be used with Pico Technology 
%Instrument Drivers as defined in the PicoStatus.h header file.
...
%
% Description:
%   This is a MATLAB class definition that defines the PICO_INFO and 
%   PICO_STATUS values defined in the picoStatus.h header file.
%
